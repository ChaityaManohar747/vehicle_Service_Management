...
public class Vehicle {
    ...
    public void get_started()
    {
      ...
      System.out.println("Welcome to our Vehicle Service Management");
        ...
        System.out.println("Enter you vehicle's Registered no");
        regno = sc.next();
...
class Two_wheeler extends Vehicle{
    ...
    public Two_wheeler()
    {
       serviceslist.add("Two-wheeler services");
    }
    public void services()     //Method Overriding
    {
        serviceslist.clear();
